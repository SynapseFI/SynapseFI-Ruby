module SynapsePayRest
  class Client
    attr_accessor :http_client, :users, :nodes, :transactions, :user_id, :http_client
    ...
    def initialize(options: raise('options is required'), user_id: nil)
      ...
      @http_client = HTTPClient.new(options, base_url, user_id: user_id, logging: options[:logging])
