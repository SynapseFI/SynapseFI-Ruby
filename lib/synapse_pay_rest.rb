...
require './lib/synapse_pay_rest/api/atms'
require './lib/synapse_pay_rest/api/crypto_quotes'
require './lib/synapse_pay_rest/api/statements'
...
require './lib/synapse_pay_rest/models/node/card_us_node.rb'
require './lib/synapse_pay_rest/models/node/subcard_us_node.rb'
require './lib/synapse_pay_rest/models/node/crypto_us_node.rb'
require './lib/synapse_pay_rest/models/node/custody_us_node.rb'
...
require './lib/synapse_pay_rest/models/atm/atm'

require './lib/synapse_pay_rest/models/crypto_quote/crypto_quote'

require './lib/synapse_pay_rest/models/statement/statement'
